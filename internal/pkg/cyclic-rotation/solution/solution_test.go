...
import (
	...
	"github.com/fvm/fluffy-meme/internal/pkg/cyclic-rotation/solution"
)
...
func TestSolution(t *testing.T) {
	...
	tests := []test{
		gen([]int{3, 8, 9, 7, 6}, 4, []int{6, 3, 8, 9, 7}),
		gen([]int{3, 8, 9, 7, 6}, 3, []int{7, 6, 3, 8, 9}),
		gen([]int{3, 8, 9, 7, 6}, 2, []int{9, 7, 6, 3, 8}),
		gen([]int{3, 8, 9, 7, 6}, 1, []int{8, 9, 7, 6, 3}),
